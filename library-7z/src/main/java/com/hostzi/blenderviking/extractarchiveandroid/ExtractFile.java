...
public class ExtractFile {
	...
	public OnCompress7zListener getListener() {
		return listener;
	}

	public void setListener(OnCompress7zListener listener) {
		this.listener = listener;
	}

	private OnCompress7zListener listener;
	...
	public interface OnCompress7zListener{
		void onSuccess();
		void onError();
	}
